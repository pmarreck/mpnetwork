...
defmodule Mpnetwork.PreviousMigrations.ReviseFulltextListingSearch do
...
defmodule Mpnetwork.Repo.Migrations.ModifyListingSearchForExpiredListings do
  use Ecto.Migration
  ...
  def down do
    ...
    Mpnetwork.PreviousMigrations.ReviseFulltextListingSearch.previous_up_statements
    |> Enum.each(&execute/1)
  end
