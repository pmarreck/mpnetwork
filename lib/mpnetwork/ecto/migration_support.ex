defmodule Mpnetwork.Ecto.MigrationSupport do
  ...
  defmacro __using__(_) do
    quote do
      ...
      @all_indexable_fields @foreign_key_searchable_fields ++
                              @fulltext_searchable_fields ++
                              @boolean_text_searchable_fields ++
                              @enum_text_searchable_fields ++
                              @ordinal_number_searchable_fields ++ @other_reindex_forcing_fields
      ...
      def listing_search_update_trigger_creation_sql do
        """
          ...
          assemble_insert_update_trigger_fields(@all_indexable_fields)
        }
          ON listings
