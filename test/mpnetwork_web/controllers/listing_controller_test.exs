defmodule MpnetworkWeb.ListingControllerTest do
  ...
  @create_upcoming_broker_oh_attrs Enum.into(%{next_broker_oh_start_at: Timex.to_naive_datetime(Timex.shift(Timex.now(), hours: 2)), next_broker_oh_end_at: Timex.to_naive_datetime(Timex.shift(Timex.now(), hours: 4)), address: "inspectionaddress", draft: false}, @create_attrs)
