defmodule Mpnetwork.SearchTest do
  ...
  describe "listing fulltext search" do
    ...
    test "listing expired search" do
      expired_listing = listing_fixture(live_at: ~N[2017-04-17 12:00:00.000000], expires_on: ~D[2017-05-17], listing_status_type: "EXP")
      ...
      _nonmatching_listing = listing_fixture(listing_status_type: "NEW", live_at: Timex.shift(Timex.now, days: -30), expires_on: Timex.today)
